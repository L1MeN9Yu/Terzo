...
extension UIApplication {
    ...
    public class var documentsURL: URL? {
        return self.shared.documentsURL
    }

    public class var libraryPath: String? {
        return self.shared.libraryPath
    }

    public class var libraryURL: URL? {
        return self.shared.libraryURL
    }

    public class var cachesPath: String? {
        return self.shared.cachesPath
    }

    public class var cachesURL: URL? {
        return self.shared.cachesURL
    }

    public class var bundleName: String? {
        return self.shared.bundleName
    }

    public class var bundleID: String? {
        return self.shared.bundleID
    }
    ...
    public class var buildVersion: String? {
        return self.shared.buildVersion
    }
